...
public class GitRepoCloner {
    ...
    Map<String, Integer> downloadTryTimes = new HashMap<>();
...
//	  		e.printStackTrace();
    ...
    public static void cloneRepository(String url, String localPath) throws GitAPIException {
        System.out.println("开始下载:" + url);
        CloneCommand cloneCommand = Git.cloneRepository().setURI(url);
        // UsernamePasswordCredentialsProvider user = new UsernamePasswordCredentialsProvider("xxx", "xxx");
